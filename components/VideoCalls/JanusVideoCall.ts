...
export class JanusVideoCall {
  ...
  protected setState = (ket: string, value: any) => {};
        ...
        janus = new Janus({
          ...
          success: () => {
            ...
            this.janus.attach({
              ...
              onlocalstream: (track: any, on: any) => {
                // ---------- onlocaltrack
              ...
              onremotestream: (track: any, mid: any, on: any, metadata: any) => {
                ...
                //     //   //~ console.info("Current bitrate is " + videocall.getBitrate());
